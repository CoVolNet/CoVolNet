...
const URL = "http://covolnet.herokuapp.com/api/forms/volunteer/"
...
const timing_list = [_7to10am, _10to1pm, _1to4pm, _4to7pm, _7to9pm, _9to11pm, _11to1am, 
                    _1to3am, _3to5am, _5to7am]
...
// makeObject
const makeObject = ({name, state, district, language_array, days_of_week, timing_list}) =>{
    let languages = []
...
test.addEventListener('click', (event) => {
    ...
    sendFetchReq(JSON.stringify(obj)).then(data => console.log(data))
})
...
//     const obj = makeObject({name, state, district, englishRadio, hindiRadio, otherRadio, otherLang})
// })
